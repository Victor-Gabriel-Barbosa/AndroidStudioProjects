 ...
 *
 * Acionado quando o dispositivo entra em uma área de geofence monitorada,
 * exibindo uma notificação para o usuário.
 */
class GeofenceReceiver : BroadcastReceiver() {
    /**
     * Método chamado quando o BroadcastReceiver está recebendo um Intent broadcast.
     *
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        geofences.forEach { geofence ->
            ...
            mostrarNotificacao(
                context = context,
                titulo = context.getString(R.string.voce_esta_perto_de_um_item_perdido),
                corpo = context.getString(R.string.voce_esta_proximo_de, localNome)
            )
        }
    }
