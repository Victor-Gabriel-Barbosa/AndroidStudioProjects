 ...
 */
interface ChatRepo {
    suspend fun save(salaId: String, mensagem: Mensagem, chatResumo: Chat): Result<Boolean>
    ...
    suspend fun deleteMsgById(salaId: String, mensagemId: String): Result<Boolean>
    suspend fun updateMsgById(salaId: String, mensagemId: String, novaMensagem: Mensagem): Result<Boolean>
}