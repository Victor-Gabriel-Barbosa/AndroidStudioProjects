...
fun TelaChatContent(
    ...
    val avaliou = chatUiState.contato?.avaliadores?.contains(chatUiState.autorUid) == true
    ...
    Scaffold(
        ...
        if (chatUiState.carregando && chatUiState.msgs.isEmpty()) FundoCarregando()
    }
}
