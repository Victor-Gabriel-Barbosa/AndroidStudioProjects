...
import com.example.mapa.ui.screens.TelaChat
import com.example.mapa.ui.screens.TelaChatList
import com.example.mapa.ui.screens.TelaHome
import com.example.mapa.ui.screens.TelaPerfil
import com.example.mapa.ui.screens.TelaSalvos
            ...
            AppNav.entries.forEach { item ->
                ...
                item(
                    ...
                    icon = {
                        ...
                        when {
                            item == AppNav.PERFIL && usuarioUiState.usuario?.foto != null -> {
                                AvatarImg(
