...
/**
 * Implementação do [UsuarioRepository] que utiliza o Firebase Firestore para o banco de dados
...
class UsuarioRepositoryImpl(
     ...
     * @return [Result.success] com `true` se a operação for bem-sucedida, [Result.failure] caso contrário.
     */
    override suspend fun updateByUid(uid: String, usuario: Usuario): Result<Boolean> {
        return try {
