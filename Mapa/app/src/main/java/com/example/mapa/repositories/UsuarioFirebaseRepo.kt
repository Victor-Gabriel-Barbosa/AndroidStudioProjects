...
/**
 * Implementação do [UsuarioRepo] que utiliza o Firebase Firestore para o banco de dados
...
class UsuarioFirebaseRepo(
     ...
     *
     * @return Um [Flow] que emite uma lista de [Usuario] sempre que houver atualizações.
     */
     ...
     * @return Um [Flow] que emite uma lista contendo o [Usuario] (ou vazia se não encontrado)
     ...
     *
     * @param usuarioUid O UID do usuário a ser atualizado.
     ...
     *
     * @param usuarioUid O UID do usuário a ser removido.
     * @return [Result.success] com `true` se a operação for bem-sucedida, [Result.failure] caso contrário.
     */
